...
public class JwtUtil {
	...
	public <T extends BaseTokenPayload> T verifyLoginToken(String tokenString, Class<T> valueType) {
		try {
			...
			// TODO: the debugNumber should probably be an errorNumber - need to
			// use builder pattern for APIException
			// and also make sure json is using errorNumbers with a fallback to
			// debugNumbers
