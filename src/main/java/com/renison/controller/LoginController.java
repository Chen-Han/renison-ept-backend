...
public class LoginController {
    ...
    public @ResponseBody ObjectNode start(@RequestBody Student student) throws JsonProcessingException, JOSEException {
        ...
        String jwt = jwtUtil.getTestSessionJwt(testSession.getId()); //TODO catch api exception and handle somewhere else
